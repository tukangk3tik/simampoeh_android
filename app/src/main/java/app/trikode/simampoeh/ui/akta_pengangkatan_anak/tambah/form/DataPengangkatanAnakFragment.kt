package app.trikode.simampoeh.ui.akta_pengangkatan_anak.tambah.form
...
import app.trikode.simampoeh.databinding.FragmentDataPengangkatanAnakBinding
...
import app.trikode.simampoeh.ui.akta_pengangkatan_anak.tambah.konfirmasi.AktaAngkatAnakKonfirmasiFragment
...
class DataPengangkatanAnakFragment : Fragment(), View.OnClickListener, DatePickerFragment.DialogDateListener {

    private var _binding: FragmentDataPengangkatanAnakBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDataPengangkatanAnakBinding.inflate(inflater, container, false)
        return binding.root
    }
            ...
            binding.btnNext.id -> {
                ...
                when {
                    ...
                    TextUtils.isEmpty(dinasAkta) -> binding.edtDinasPenerbitAkta.error = GeneralUtils.WRONG_FORMAT
                        ...
                        val dataBerkas = AktaPengangkatanAnakResponse(
                        ...
                        tambahAktaPengangkatanAnakViewModel.dataPengajuan = dataBerkas
                        ...
                        mTujuanFragment.setEndFragment(AktaAngkatAnakKonfirmasiFragment.newInstance())
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = DataPengangkatanAnakFragment()
    }
