package app.trikode.simampoeh.core.data.source.remote.response.akta_pengangkatan_anak

import app.trikode.simampoeh.core.data.source.remote.response.ITujuanKirim
import com.google.gson.annotations.SerializedName

data class AktaPengangkatanAnakResponse(

    @field:SerializedName("request")
    var request: String = "tambah_angkatanak",
