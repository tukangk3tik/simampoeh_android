package app.trikode.simampoeh.core.data.source.remote.response.anak_pengesahan_anak

import app.trikode.simampoeh.core.data.source.remote.response.ITujuanKirim
import com.google.gson.annotations.SerializedName

data class AktaPengesahanAnakResponse(

    @field:SerializedName("request")
    var request: String = "tambah_sahanak",
